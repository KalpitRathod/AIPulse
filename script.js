                        ...
                        <div class="container px-4 px-lg-5 my-5">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 mt-5 mt-lg-0 text-center">
                                    <img class="img-fluid rounded-4 shadow-lg border border-secondary" width="100%" height="400" style="max-height: 400px; object-fit: cover; filter: drop-shadow(0 0 20px rgba(168, 85, 247, 0.2));" src="${fPost.image_url || 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1200'}" alt="${fPost.title}">
                                </div>
                            </div>
                        </div>
                    </header>`;
                ...
                if (articles && articles.length > 0) {
                    ...
                    articles.forEach(article => {
                        ...
                        <div class="card mb-4 border-0 shadow-sm rounded-4 overflow-hidden blog-card widget-card d-flex flex-column h-100">
                            <a href="/post/${article.slug || article.id}" tabindex="-1" aria-hidden="true"><img class="card-img-top border-bottom border-secondary" width="100%" height="250" style="height: 250px; object-fit: cover;" src="${article.image_url || 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800'}" alt="${article.title}" /></a>
